      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {filteredPosts.map((post, index) => (
            ...
            >
              <div className="relative h-56 overflow-hidden">
                ...
                />
                <div className="absolute top-4 left-4 bg-[#78912b] text-white px-3 py-1 rounded-full text-sm font-semibold">
                  {post.category}
                </div>
              </div>
              <div className="p-6">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-[#78912b] transition-colors">
                  {post.title}
                </h3>
                ...
                <div className="flex items-center justify-between">
                  ...
                  {post.link ? (
                    <a 
                      ...
                      className="flex items-center gap-2 text-[#78912b] font-semibold hover:gap-4 transition-all duration-300"
                    >
        ...
        <div className="text-center mt-12">
          <a 
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block bg-[#78912b] text-white px-8 py-4 rounded-full hover:bg-[#4e2b14] transition-all duration-300 transform hover:scale-105"
          >
            Read More Articles
          </a>
        </div>
