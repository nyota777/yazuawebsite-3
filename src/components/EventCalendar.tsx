      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  >
                    <CalendarIcon className="w-5 h-5 text-[#c7211a] hover:text-[#4e2b14]" />
                  </button>
                </div>
                <h3 className="text-xl font-bold text-gray-900 mb-4 group-hover:text-[#c7211a] transition-colors">
                  {event.title}
                </h3>
        ...
        <div className="text-center mt-12">
          <button
            ...
            className="inline-block bg-[#c7211a] text-white px-8 py-4 rounded-full hover:bg-[#4e2b14] transition-all duration-300 transform hover:scale-105 font-semibold"
          >
            View Full Calendar
          </button>
        </div>
                ...
                <div className="border-t border-gray-200 pt-6">
                  <Calendar
                    ...
                    classNames={{
                      ...
                      day_selected: 'bg-[#c7211a] text-white hover:bg-[#4e2b14] hover:text-white focus:bg-[#c7211a] focus:text-white',
                      ...
                      day_range_middle: 'aria-selected:bg-red-100 aria-selected:text-gray-900',
